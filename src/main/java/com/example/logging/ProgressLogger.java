...
public class ProgressLogger extends AbstractLogger {
    ...
    public void start(long targetCount, LocalDateTime expected) {
    ...
    public void progress(long completedCount) {
        ...
        long elapseSec = startDateTime.until(current, ChronoUnit.SECONDS);
        double unitSec = (double) elapseSec / (double) completedCount;
    ...
    protected void handleNormalizedLoggingCall(Level level, Marker marker, String messagePattern, Object[] arguments, Throwable throwable) {
        delegate.atLevel(level)
                .addMarker(marker == null ? Markers.PROGRESS : marker)
